  ...
  return(
    <tr key={i}>
      ...
      <td className={`${Text} float-right flex-rows gap-2`}>
        ...
        <button className='bg-subMain text-white rounded flex items-center justify-center w-6 h-6'>
  <MdDelete/> 
</button>
            </>
          ):(
        ...
        <Link to={`/movie/${movie?.name}`}className='bg-subMain text-white rounded flex items-center justify-center w-6 h-6'>
  <GoEye/> 
</Link>
            </>
