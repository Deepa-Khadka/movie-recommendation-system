      ...
      <div className='my-20 py-10 md:px-20 px-8 bg-dry'>
        <div className='lg:grid lg:grid-cols-2 lg:gap-10 items-center'>
          <div className='flex lg:gap-10 gap-6 flex-col'>
            ...
            Access the downloaded movie and start watching it.Downloading movies for offline viewing offers a convenient and flexible way to enjoy your favorite films.
